...
/*
 ...
 |--------------------------------------------------------------------------
 */
$config['app_key'] = '4erV8DE25KUMxbcvB5vYLF6HUFCCuEAZ';
...
$config['test_params'] = array(
    ...
    array(
        ...
        'api_id'      => 'J0101',
        'name'        => 'paramsmoditest',
        'image_url'   => '/paramsmodi/test.img',
        'auth_token'  => 'paramsmoditest',
        'secret_key'  => 'paramsmoditest',
        'facebook_id' => 'paramsmoditest'
    ),
    // T_USER_LOGOUT
    array(
        'app_key'   => $common_params['app_key'], 
