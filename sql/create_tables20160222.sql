...
--
-- Table structure for table `m_event_group`
--

DROP TABLE IF EXISTS `m_event_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `m_event_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'イベントグループマスタID',
  `m_event_id` int(11) NOT NULL COMMENT 'イベントマスタID',
  `start_at` datetime NOT NULL COMMENT '開始日時※イベント期間中におけるグループの開始日時',
  `end_at` datetime NOT NULL COMMENT '終了日時※イベント期間中におけるグループの終了日時',
  `del_flg` char(1) NOT NULL DEFAULT '0' COMMENT '削除フラグ　0:off, 1:on',
  `created_at` datetime NOT NULL COMMENT '作成日時',
  `created_by` varchar(256) NOT NULL DEFAULT '' COMMENT '作成者',
  `updated_at` datetime NOT NULL COMMENT '更新日時',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='イベントグループマスタ';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_event_group`
--

LOCK TABLES `m_event_group` WRITE;
/*!40000 ALTER TABLE `m_event_group` DISABLE KEYS */;
INSERT INTO `m_event_group` VALUES (1,1,'2016-02-01 00:00:00','2016-02-29 23:59:59','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(2,1,'2016-03-01 00:00:00','2016-03-31 23:59:59','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa');
/*!40000 ALTER TABLE `m_event_group` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `m_event_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'イベントメンバマスタID',
  `m_event_group_id` int(11) NOT NULL COMMENT 'イベントグループID',
  `user_id` int(11) NOT NULL COMMENT 'イベントメンバーのユーザID(1)',
  `del_flg` char(1) NOT NULL DEFAULT '0' COMMENT '削除フラグ　0:off, 1:on',
  `created_at` datetime NOT NULL COMMENT '作成日時',
  `created_by` varchar(256) NOT NULL DEFAULT '' COMMENT '作成者',
  `updated_at` datetime NOT NULL COMMENT '更新日時',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='イベントメンバマスタ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_event_member` VALUES (1,1,1,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(2,1,2,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(3,1,3,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(4,1,4,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(5,1,5,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(6,2,6,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(7,2,7,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(8,2,8,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(9,2,9,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(10,2,10,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa');
...
CREATE TABLE `m_event_reward` (
  ...
  `m_event_id` int(11) NOT NULL COMMENT 'イベントマスタID',
  `priority` int(11) NOT NULL COMMENT '優先度 0：優先度最大、以降増えるごとに優先度が下がる',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='イベント報酬マスタ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_event_reward` VALUES (1,1,0,0,10,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(2,1,1,0,1,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(3,1,2,0,5,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(4,1,3,0,10,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(5,1,4,0,20,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(6,1,5,0,30,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(7,1,9,0,50,'0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa');
...
CREATE TABLE `m_event_stage` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'イベントステージマスタID',
  `m_event_group_id` int(11) NOT NULL COMMENT 'イベントグループID',
  `m_stage_id` int(11) NOT NULL COMMENT 'ステージID',
  `stage_order` int(11) NOT NULL COMMENT 'ステージ順※0：1面～以降増えるごとに次面になる',
  `last_stage_flg` char(1) NOT NULL DEFAULT '0' COMMENT '最終面フラグ　0:off, 1:on',
  `del_flg` char(1) NOT NULL DEFAULT '0' COMMENT '削除フラグ　0:off, 1:on',
  `created_at` datetime NOT NULL COMMENT '作成日時',
  `created_by` varchar(256) NOT NULL DEFAULT '' COMMENT '作成者',
  `updated_at` datetime NOT NULL COMMENT '更新日時',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='イベントステージマスタ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_event_stage` VALUES (1,1,1,1,'0','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(2,1,2,2,'0','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(3,1,3,3,'0','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(4,1,4,4,'0','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(5,1,5,5,'1','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(6,2,1,1,'0','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(7,2,2,2,'0','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(8,2,3,3,'0','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(9,2,4,4,'0','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa'),(10,2,5,5,'1','0','2016-02-22 18:00:00','kamikawa','2016-02-22 18:00:00','kamikawa');
...
CREATE TABLE `m_stage_fence` (
  ...
  `size_x` int(11) NOT NULL COMMENT 'フェンスのX方向の大きさ',
  `size_y` int(11) NOT NULL COMMENT 'フェンスのY方向の大きさ',
  `del_flg` char(1) NOT NULL DEFAULT '0' COMMENT '削除フラグ　0:off, 1:on',
  `created_at` datetime NOT NULL COMMENT '作成日時',
  `created_by` varchar(256) NOT NULL DEFAULT '' COMMENT '作成者',
  `updated_at` datetime NOT NULL COMMENT '更新日時',
...
INSERT INTO `m_stage_fence` VALUES (1,1,-2,3,5,1,'0','2016-02-22 11:00:00','kamikawa','2016-02-22 11:00:00','kamikawa'),(2,1,3,-2,1,5,'0','2016-02-22 11:00:00','kamikawa','2016-02-22 11:00:00','kamikawa'),(3,1,-2,-3,5,1,'0','2016-02-22 11:00:00','kamikawa','2016-02-22 11:00:00','kamikawa'),(4,1,-3,-2,1,5,'0','2016-02-22 11:00:00','kamikawa','2016-02-22 11:00:00','kamikawa'),(5,2,-4,4,9,1,'0','2016-02-22 11:00:00','kamikawa','2016-02-22 11:00:00','kamikawa'),(6,2,5,-3,1,7,'0','2016-02-22 11:00:00','kamikawa','2016-02-22 11:00:00','kamikawa'),(7,2,-4,-4,9,1,'0','2016-02-22 11:00:00','kamikawa','2016-02-22 11:00:00','kamikawa'),(8,2,-5,-3,1,7,'0','2016-02-22 11:00:00','kamikawa','2016-02-22 11:00:00','kamikawa');
...
CREATE TABLE `m_stage_jelly` (
  ...
  `type` int(11) NOT NULL COMMENT 'ゼリー種別　0:障害物, 1:ユーザが動かすゼリー, 2:不動ゼリー, 3:不動ゼリーのゴール, 4:連動ゼリー, 5:連動ゼリーのゴール',
  `del_flg` char(1) NOT NULL DEFAULT '0' COMMENT '削除フラグ　0:off, 1:on',
  `created_at` datetime NOT NULL COMMENT '作成日時',
  `created_by` varchar(256) NOT NULL DEFAULT '' COMMENT '作成者',
  `updated_at` datetime NOT NULL COMMENT '更新日時',
...
INSERT INTO `m_stage_jelly` VALUES (1,1,2,2,1,1,1,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa'),(2,1,2,2,2,2,2,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa'),(3,1,2,2,2,2,3,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa'),(4,2,2,2,1,1,0,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa'),(5,2,2,2,2,2,1,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa'),(6,2,2,2,2,2,2,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa'),(7,2,2,2,3,3,3,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa');
...
CREATE TABLE `t_event_king` (
  ...
  `m_event_member_id` int(11) NOT NULL COMMENT 'イベントメンバマスタID',
  `user_id` int(11) NOT NULL COMMENT 'ユーザID',
  `success_date` datetime NOT NULL COMMENT 'キング達成日時',
  `success_count` int(11) NOT NULL COMMENT 'キング達成回数',
  `m_event_reward_id` int(11) DEFAULT NULL COMMENT 'イベント報酬リストID',
  ...
  `updated_by` varchar(256) NOT NULL DEFAULT '' COMMENT '更新者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='イベントキング情報';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_event_king` VALUES (1,1,1,'2016-02-24 18:52:35',1,2,'1','0','2016-02-24 18:52:35','::1','2016-02-24 18:52:58','::1'),(2,1,2,'2016-02-24 18:52:58',1,3,'1','0','2016-02-24 18:52:58','::1','2016-02-24 18:58:06','::1'),(3,1,1,'2016-02-24 18:58:06',2,3,'1','0','2016-02-24 18:58:06','::1','2016-02-24 19:05:46','::1'),(4,1,2,'2016-02-24 19:05:46',2,NULL,'0','0','2016-02-24 19:05:46','::1','2016-02-24 19:05:46','::1');
...
CREATE TABLE `t_event_stage` (
  ...
  `m_event_stage_id` int(11) NOT NULL COMMENT 'イベントステージマスタID',
  `user_id` int(11) NOT NULL COMMENT 'ユーザID',
  `m_stage_id` int(11) NOT NULL COMMENT 'ステージリストID',
  `status` char(1) NOT NULL DEFAULT '0' COMMENT 'ステータス　0:クリア失敗, 1:クリア済',
  `del_flg` char(1) NOT NULL DEFAULT '0' COMMENT '削除フラグ　0:off, 1:on',
  `created_at` datetime NOT NULL COMMENT '作成日時',
  `created_by` varchar(256) NOT NULL DEFAULT '' COMMENT '作成者',
  `updated_at` datetime NOT NULL COMMENT '更新日時',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='イベントステージ情報';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_event_stage` VALUES (1,1,1,1,'0','0','2016-02-23 15:00:00','kamikawa','2016-02-23 15:00:00','kamikawa'),(2,1,1,1,'1','0','2016-02-23 15:00:00','kamikawa','2016-02-23 15:00:00','kamikawa'),(3,1,1,1,'0','0','2016-02-23 15:00:00','kamikawa','2016-02-23 15:00:00','kamikawa'),(4,1,2,1,'1','0','2016-02-23 15:00:00','kamikawa','2016-02-23 15:00:00','kamikawa'),(26,5,2,5,'1','0','2016-02-24 18:03:44','::1','2016-02-24 18:03:44','::1'),(33,5,1,5,'1','0','2016-02-24 18:13:53','::1','2016-02-24 18:13:53','::1'),(34,5,2,5,'1','0','2016-02-24 18:18:16','::1','2016-02-24 18:18:16','::1'),(35,5,1,5,'1','0','2016-02-24 18:21:49','::1','2016-02-24 18:21:49','::1'),(36,5,1,5,'1','0','2016-02-24 18:22:06','::1','2016-02-24 18:22:06','::1'),(37,5,1,5,'1','0','2016-02-24 18:23:00','::1','2016-02-24 18:23:00','::1'),(38,5,1,5,'1','0','2016-02-24 18:25:01','::1','2016-02-24 18:25:01','::1'),(39,5,1,5,'1','0','2016-02-24 18:25:10','::1','2016-02-24 18:25:10','::1'),(40,5,2,5,'1','0','2016-02-24 18:48:20','::1','2016-02-24 18:48:20','::1'),(41,5,1,5,'1','0','2016-02-24 18:51:42','::1','2016-02-24 18:51:42','::1'),(42,5,1,5,'1','0','2016-02-24 18:52:35','::1','2016-02-24 18:52:35','::1'),(43,5,2,5,'1','0','2016-02-24 18:52:58','::1','2016-02-24 18:52:58','::1'),(44,5,1,5,'1','0','2016-02-24 18:58:06','::1','2016-02-24 18:58:06','::1'),(45,5,2,5,'1','0','2016-02-24 19:05:46','::1','2016-02-24 19:05:46','::1');
...
CREATE TABLE `t_friend` (
  ...
  `user_id` int(11) NOT NULL COMMENT 'ユーザID',
  `friend_id_list` text DEFAULT NULL COMMENT 'フレンド関係にあるユーザID群',
  `del_flg` char(1) NOT NULL DEFAULT '0' COMMENT '削除フラグ　0:off, 1:on',
  `created_at` datetime NOT NULL COMMENT '作成日時',
  `created_by` varchar(256) NOT NULL DEFAULT '' COMMENT '作成者',
  `updated_at` datetime NOT NULL COMMENT '更新日時',
...
INSERT INTO `t_gold` VALUES (1,1,998432,900102,98330,'0','2016-01-26 11:00:00','kamikawa','2016-02-24 19:05:46','::1'),(2,2,100,29,71,'0','2016-01-26 11:00:00','kamikawa','2016-02-24 19:05:46','::1'),(3,3,0,0,0,'0','2016-01-29 11:15:57','::1','2016-01-29 11:15:57','::1'),(4,4,10,10,0,'0','2016-01-29 11:30:00','kamikawa','2016-01-29 11:30:00',''),(5,4,0,0,0,'0','2016-01-29 11:28:51','::1','2016-01-29 11:28:51','::1'),(6,5,0,0,0,'0','2016-02-01 18:11:02','::1','2016-02-01 18:11:02','::1'),(7,6,0,0,0,'0','2016-02-02 17:08:43','::1','2016-02-02 17:08:43','::1'),(13,12,0,0,0,'0','2016-02-03 16:34:58','::1','2016-02-03 16:34:58','::1'),(23,22,0,0,0,'0','2016-02-03 17:08:52','::1','2016-02-03 17:08:52','::1'),(24,23,0,0,0,'0','2016-02-08 12:27:06','::1','2016-02-08 12:27:06','::1'),(25,24,0,0,0,'0','2016-02-19 12:31:13','::1','2016-02-19 12:31:13','::1'),(27,26,0,0,0,'0','2016-02-19 12:39:52','::1','2016-02-19 12:39:52','::1'),(28,27,0,0,0,'0','2016-02-19 12:42:26','::1','2016-02-19 12:42:26','::1'),(29,28,100,50,50,'0','2016-02-22 12:14:04','::1','2016-02-22 12:14:04','::1');
...
CREATE TABLE `t_gold_history` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='有償ゴールド購入履歴情報';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_gold_history` VALUES (3,0,1,'1',1,'0','2016-02-12 16:51:47','::1','2016-02-12 16:51:47','::1'),(4,0,1,'1',1,'0','2016-02-12 16:52:49','::1','2016-02-12 16:52:49','::1'),(5,0,1,'1',1,'0','2016-02-12 16:53:53','::1','2016-02-12 16:53:53','::1'),(6,0,1,'0',1,'0','2016-02-12 17:03:35','::1','2016-02-12 17:03:35','::1'),(7,0,1,'0',1,'0','2016-02-12 17:13:21','::1','2016-02-12 17:13:21','::1'),(8,0,1,'0',1,'0','2016-02-12 17:18:40','::1','2016-02-12 17:18:40','::1'),(9,0,1,'0',1,'0','2016-02-12 17:55:22','::1','2016-02-12 17:55:22','::1'),(10,0,1,'0',1,'0','2016-02-12 17:56:06','::1','2016-02-12 17:56:06','::1'),(11,0,1,'0',1,'0','2016-02-12 17:57:16','::1','2016-02-12 17:57:16','::1'),(12,0,1,'0',1,'0','2016-02-12 17:57:41','::1','2016-02-12 17:57:41','::1'),(13,0,1,'0',1,'0','2016-02-12 18:01:25','::1','2016-02-12 18:01:25','::1'),(14,0,1,'1',1,'0','2016-02-12 18:11:30','::1','2016-02-12 18:11:30','::1'),(15,2,1,'0',1,'0','2016-02-22 13:16:29','::1','2016-