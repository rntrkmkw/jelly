...
CREATE TABLE `m_gold_ios` (
  ...
  `language` char(1) NOT NULL DEFAULT '' COMMENT '言語(Apple管理用)　0:日本語 1:英語',
...
INSERT INTO `m_gold_ios` VALUES (1,'11111111','10ゴールド','AAAAAAAA','0','0','10ゴールド','アプリ内通貨10ゴールド分','1',100,'0000-00-00 00:00:00','0000-00-00 00:00:00',10,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa'),(2,'22222222','30ゴールド','BBBBBBBB','0','0','30ゴールド','アプリ内通貨30ゴールド分','1',200,'0000-00-00 00:00:00','0000-00-00 00:00:00',30,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa'),(3,'33333333','1,000ゴールド','CCCCCCCC','0','0','1,000ゴールド','アプリ内通貨1,000ゴールド分','1',800,'0000-00-00 00:00:00','0000-00-00 00:00:00',1000,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa'),(4,'44444444','5,000ゴールド','DDDDDDDD','0','0','5,000ゴールド','アプリ内通貨5,000ゴールド分','1',3000,'0000-00-00 00:00:00','0000-00-00 00:00:00',5000,'0','2016-01-18 11:00:00','kamikawa','2016-01-18 11:00:00','kamikawa');
...
CREATE TABLE `m_stage_jelly` (
  ...
  `position_x` int(11) NOT NULL COMMENT 'X座標',
  `position_y` int(11) NOT NULL COMMENT 'Y座標',
  `position_range_x` int(11) NOT NULL COMMENT 'X座標のレンジ',
  `position_range_y` int(11) NOT NULL COMMENT 'Y座標のレンジ',
...
CREATE TABLE `t_gold` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='ゴールド情報';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_gold` VALUES (1,1,0,0,0,'0','2016-02-02 03:52:13','192.168.0.25','2016-02-02 03:52:13','192.168.0.25');
...
CREATE TABLE `t_user` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='ユーザ情報';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_user` VALUES (1,'','','1','','','','','0','','','','','','0','2016-02-02 03:52:13','192.168.0.25','2016-02-03 11:04:15','192.168.0.25');
...
-- Dump completed on 2016-02-09 12:02:42
